 ...
 */
function defineTable<Table, TableFormData extends Partial<Table>, GetOptions extends GetTableOpts<Table>, UpdateOptions extends UpdateTableOpts<Table>>(supabase: SupabaseClient, tableName: string, behaviour: TableBehaviour<Table>): ClientWrapper<Table, TableFormData, GetOptions, UpdateOptions> {
